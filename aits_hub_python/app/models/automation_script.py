...
class AutomationScript(SoftDeleteMixin, Base):
    ...
    heal_enabled = Column(Boolean, default=True, comment="是否启用自愈：true/false")
    heal_count = Column(Integer, default=0, comment="累计自愈成功次数")
    last_healed_at = Column(DateTime, nullable=True, comment="最后自愈时间")
